...
class ContactsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('contact.index', compact('contact','modul'));
    }
    ...
    {
        $modul = $this->modul;
        return view('contact.create', compact('modul'));
    }
    public function edit($id)
    {
        ...
        return view('contact.edit', compact('contact','modul'));
    }
