...
<head>
  ...
  <title>Website Pariwisata Kota Gorontalo</title>
...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <a href="visit" class="hero-logo" data-aos="zoom-in"><img src="assets/img/logo.png" alt=""></a>
      <h1 data-aos="zoom-in">Selamat Datang di Website <br> Pariwisara Kota Gorontalo</h1>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul class="nav-inner">
          <li class="active"><a href="visit/">Home</a></li>
          <li class="drop-down"><a href="">Wisata</a>
            <ul>
                @foreach ( $category as $item )
              <li><a href="{{ route('listAlam', $item->id) }}">{{$item->name}}</a></li>
          ...
          {{-- <li><a href="#portfolio">Kuliner</a></li> --}}
  ...
  <main id="main">
    ...
    <section id="about" class="pricing section-bg">

        {{-- <div class="col-lg-2 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="100">
        <a href="{{ route('listAlam', $item->id) }}">{{$item->name}}</a>
          </div>
          @endforeach
          <div class="container"> --}}
      ...
      <div class="container">
        <form action="./visit/search" method="GET">
    ...
    {{-- <div class="form-group row">
        ...
        {{-- <div class="section-title" data-aos="fade-up">
            <h2>Wisata</h2>
            <p>Wisata yang ada di Kota Gorontalo</p>
          </div>
        <div class="row">
                  @foreach ($category as $item )
                ...
                <div class="col-lg-4 col-md-7">
                  <div class="box" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="btn-wrap">
                      <a href="{{ route('listAlam', $item->id) }}" class="btn-buy">{{$item->name}}</a>
                    </div>
                  </div>
                </div>
                @endforeach
    ...
    {{-- <section id="services" class="services"> --}}
        <section id="services" class="pricing section-bg" style="background-color: white">
            <div class="container">

              <div class="section-title" data-aos="fade-up">
                <h2>Hotel</h2>
                <p>Hotel yang ada di Kota Gorontalo</p>
              </div>
      <div class="container">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-7" >
                  <div class="box  " data-aos="zoom-in" data-aos-delay="100" style="background-color: gainsboro" >
                      <div class="member-img">
                      <img src="{{ asset($item->pic1) }}" alt="Avatar"  class="img-fluid">

                      </div>
                    <div class="btn-wrap">
                      <a href="{{ route($h.'.show', $item->id) }}" class="btn-buy">Info Detail</a>
                    </div>
                  </div>
                </div>
                @endforeach
    ...
    <section id="kuliner" class="pricing section-bg" >
        <div class="container" >
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-7">
              <div class="box" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="btn-wrap">
                  <a href="{{ route($k.'.show', $item->id) }}" class="btn-buy">Info Detail</a>
                </div>
              </div>
            </div>
            @endforeach
...
<div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-7">
            <div class="box" data-aos="zoom-in" data-aos-delay="100">
                <div class="member-img">
                <img src="{{ asset($item->pic) }}" alt="Avatar"  class="img-fluid">
                </div>
              <div class="btn-wrap">
                <a href="{{ route($e.'.show', $item->id) }}" class="btn-buy">Info Detail</a>
              </div>
            </div>
          </div>
          @endforeach
...
@foreach ( $contact as $item )
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="{{ route($c.'.store')}}" method="POST" role="form" class="php-email-form" data-aos="fade-left">
                @csrf
                <div class="form-row">
                <div class="col-md-6 form-group">
                  <input type="text" name="location" class="form-control" id="location" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
              ...
              <div class="form-group">
                <textarea class="form-control" name="messege" id="messege" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Message"></textarea>
                <div class="validate"></div>
              </div>
              <div class="mb-3">
