        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Nama Event</strong>:  {{ $events->nama}}</li>
              <li><strong>Lokasi</strong>: {{ $events->location}}</li>
              <li><strong>Waktu</strong>:{{ $events->day}} || {{ $events->time}}</li>
            </ul>
          </div>
