...
<body>
  ...
  <main id="main">
    ...
    <section id="portfolio-details" class="portfolio-details" data-aos="fade-up" data-aos-delay="100">
        ...
        @foreach ( $wis as $item)    <div class="container">

        <div class="portfolio-details-container">

          <div class="owl-carousel  portfolio-details-carousel">
            <img src="{{ asset($item->pic1) }}" >
            <img src="{{ asset($item->pic2) }}" >
            <img src="{{ asset($item->pic3) }}" >
            <img src="{{ asset($item->pic4) }}" >
          ...
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Nama Wisata</strong>:  {{ $item->name}}</li>
              <li><strong>Lokasi</strong>: {{ $item->address}}</li>
