      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="owl-carousel  portfolio-details-carousel">
            <img src="{{ asset($kuliner->pic1) }}" >
            <img src="{{ asset($kuliner->pic2) }}" >
            <img src="{{ asset($kuliner->pic3) }}" >
            <img src="{{ asset($kuliner->pic4) }}" >
          ...
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Nama Event</strong>:  {{ $kuliner->nama}}</li>
              <li><strong>Lokasi</strong>: {{ $kuliner->address}}</li>
              <li><strong>Lokasi</strong>: {{ $kuliner->jarak}}</li>
              {{-- <li><strong>Waktu</strong>:{{ $kuliner->day}} || {{ $events->time}}</li> --}}
            </ul>
          </div>
